...
public class MenuScreen implements Screen {
    ...
    public MenuScreen(MyGdxGame myGdxGame) {
        ...
        TextView scr1 = new TextView(myGdxGame.largeFont1.bitmapFont, "-", 125, 1500);
        TextView scr2 = new TextView(myGdxGame.largeFont1.bitmapFont, "-", 125, 1400);
        TextView scr3 = new TextView(myGdxGame.largeFont1.bitmapFont, "-", 125, 1300);
        TextView scr4 = new TextView(myGdxGame.largeFont1.bitmapFont, "-", 125, 1200);
        TextView scr5 = new TextView(myGdxGame.largeFont1.bitmapFont, "-", 125, 1100);
