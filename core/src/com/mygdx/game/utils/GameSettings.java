...
public class GameSettings {
    ...
    public static final int COUNT_OF_SIZE_HEIGHT_EASY = 20;
    public static final int COUNT_OF_SIZE_HEIGHT_MEDIUM = 26;
    public static final int COUNT_OF_SIZE_HEIGHT_HARD = 30;
